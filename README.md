# 🎯 QA Engineer Portfolio - Yasin Asif

![Manual Testing](https://img.shields.io/badge/Testing-Manual-blue)
![Automation](https://img.shields.io/badge/Automation-Learning-yellow)
![Python](https://img.shields.io/badge/Python-Upcoming-orange)
...
│
├── 04-Performance-Testing/         ← Week 18
│   └── JMeter_Projects/
│
├── 05-CI-CD-and-DevOps/           ← Week 19
│   ├── Jenkins_Pipelines/
│   └── GitHub_Actions/
│
...
**Timeline:** 6 months from October 2025  
**Salary Range:** $30k-$50k (Pakistan market)  
...
**Key Learnings:**
- Difference between Severity (technical impact) vs Priority (business urgency)
- Importance of clear reproduction steps in bug reports
- Test case design requires thinking from user's perspective
...
- Master Git commands
- Learn Python basics
- Solve 20 HackerRank problems

---

### Week 2: Git & Python (Upcoming) 📍
*To be updated*
...
👋 Hi! If you're reviewing my portfolio:

✅ **Real Projects:** Every project here is built from scratch, not copied  
✅ **Progressive Learning:** Organized week-by-week showing clear growth  
...
Feel free to use templates and structure for your own learning journey!
